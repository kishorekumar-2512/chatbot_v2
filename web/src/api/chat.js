 ...
 */
export async function sendChatStream(question, context = null, orgId = null, imageBase64 = null, signal = null) {
  return postStream('/chat/stream', { question, context, org_id: orgId, image_base64: imageBase64 }, signal);
}
